...
function _with_file_only_detail_logging(logging::LoggingConfig;
                                        log_dir::Union{Nothing,
                                                       AbstractString} = logging.log_dir)
    return _with_logging_config(logging;
                                native_stream_mode = _logging_mode_file_only(logging.native_stream_mode),
                                integration_detail_mode = _logging_mode_file_only(logging.integration_detail_mode),
